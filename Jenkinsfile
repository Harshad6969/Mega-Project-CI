pipeline {
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'main', credentialsId: 'git', url: 'https://github.com/Harshad6969/Mega-Project-CD.git'
            }
        }
                ...
                script {
                    ...
                    withCredentials([usernamePassword(credentialsId: 'git', usernameVariable: 'GIT_USERNAME', passwordVariable: 'GIT_PASSWORD')]) {
                        sh '''
                            ...
                            git clone https://${GIT_USERNAME}:${GIT_PASSWORD}@github.com/Harshad6969/Mega-Project-CD.git
                            
                            # Update the image tag in the manifest.yaml file
                            cd Mega-Project-CD
                            sed -i "s|harshad6989/bankapp:.*|harshad6989/bankapp:${IMAGE_TAG}|" Manifest/manifest.yaml
    ...
    always {
        script {
            ...
            emailext (
                ...
                body: body,
                to: 'harshadbhargude0@gmail.com',
                from: 'harshadbhargude0@gmail.com',
                replyTo: 'bhargudeharshad@gmail.com',
                mimeType: 'text/html',
